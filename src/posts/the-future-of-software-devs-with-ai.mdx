...
The issue ended up being where I had placed `generateStaticParams` in my code (continuing to fuel my annoyance at the fact every page must be named `page.tsx`)
