...
* Cohesive Theme
* Light/Dark Mode (That BOTH look good. Too often I run into webpages that have light/dark, but one or the other is clearly an afterthought)

DaisyUI supports multiple themes and theme toggling via the use of a `Context`
