  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] justify-items-center p-8 pb-20 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <p>
          If you have stumbled upon this page, chances are you are a potential employer. You noticed he was bold enough
        ...
        <p>
          ...
          code snippets/configs/etc. Nothing is more frustrating than a jumbled mess of code and config files
          that aren't building as expected/ rendering as intended and not knowing where to even begin looking to solve the problem.
        </p>
        <p>Check out my blog to follow the construction progress of the site</p>
      </main>
    </div>
  );
}
